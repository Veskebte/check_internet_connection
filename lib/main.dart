...
class _MyHomePageState extends State<MyHomePage> {
  ...
  late StreamSubscription<List<ConnectivityResult>> _connetivitySubscription;
  ...
  void initState() {
    ...
    // Memanggil fungsi pengecekan koneksi internet
    _initConnectionStatus().then((_) {
      _connetivitySubscription =
  ...
  void dispose() {
    // TODO: implement dispose
    super.dispose();
    //Batalkan langganan saat widget dihancurkan
    _connetivitySubscription.cancel();
  }

  // Fungsi untuk memeriksa status koneksi internet saat pertama kali aplikasi di jalankan
